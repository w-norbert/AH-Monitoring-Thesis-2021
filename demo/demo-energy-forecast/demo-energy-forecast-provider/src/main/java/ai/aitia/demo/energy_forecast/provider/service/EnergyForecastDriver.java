...
public class EnergyForecastDriver {
    ...
    private EnergyDetailsListDTO consumeEnergyDetailsService(final OrchestrationResultDTO orchestrationResult, final long building, final long from, final long to) {
		...
		arrowheadService.monitorConnection(orchestrationResult, getInterface());
		EnergyDetailsListDTO result = arrowheadService.consumeServiceHTTP(EnergyDetailsListDTO.class, HttpMethod.valueOf(orchestrationResult.getMetadata().get(EFCommonConstants.HTTP_METHOD)),
												   orchestrationResult.getProvider().getAddress(), orchestrationResult.getProvider().getPort(), orchestrationResult.getServiceUri(),
												   getInterface(), token, null, queryParam);
		//arrowheadService.terminateConnection(orchestrationResult, getInterface());
		return result;
    }
